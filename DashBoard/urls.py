...
from .views import (
    ...
    GeneratePaymentLinkView, SubmitPaymentProofView, UploadPaymentStatementView
)
...
urlpatterns = [
    ...
    path('upload-payment-statement/', UploadPaymentStatementView.as_view(), name='upload_payment_statement'),
]
